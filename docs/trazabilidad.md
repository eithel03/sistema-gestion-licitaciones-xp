...
| --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HU-01 | Iteracion 1 | Alta | 3 | Definidos en `historias-usuario.md` | Navegacion y E2E inicial | Interfaz | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-02 | Iteracion 1 | Alta | 2 | Definidos en `historias-usuario.md` | Revision visual y E2E | Interfaz | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-03 | Iteracion 1 | Alta | 2 | Definidos en `historias-usuario.md` | Mensajes en formularios | Interfaz | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-04 | Iteracion 1 | Media | 3 | Definidos en `historias-usuario.md` | Listados y parametros | Interfaz, API REST | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-05 | Iteracion 1 | Alta | 3 | Definidos en `historias-usuario.md` | Unitarias e integracion | Proveedores | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-06 | Iteracion 1 | Alta | 2 | Definidos en `historias-usuario.md` | Funcionales e integracion | Proveedores | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-07 | Iteracion 1 | Alta | 3 | Definidos en `historias-usuario.md` | Integracion | Proveedores | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-08 | Iteracion 1 | Alta | 5 | Definidos en `historias-usuario.md` | Unitarias e integracion | Proveedores, persistencia | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-09 | Iteracion 1 | Media | 2 | Definidos en `historias-usuario.md` | Unitarias | Proveedores | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
| HU-10 | Iteracion 1 | Alta | 5 | Definidos en `historias-usuario.md` | Integracion de endpoints | Proveedores, API REST | Pendiente | Pendiente | Pendiente | Pendiente | `historias-usuario.md`, `iteracion-01.md` | v0.1.0 |
