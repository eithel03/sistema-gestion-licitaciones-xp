...
- Limitaciones de evidencia: Issue, commits finales, Pull Request, CI remoto posterior al push, revisión formal final del Navigator, merge, tag `v1.0.0-rc` y GitHub Release permanecen pendientes.
